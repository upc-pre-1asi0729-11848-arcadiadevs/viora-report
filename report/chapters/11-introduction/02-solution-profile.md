...
![Indicadores recientes de variación productiva y recuperación](report/assets/graphics/valor_produccion_midagri.png){width=80%}

*Nota.* En el mes de setiembre el sector agropecuario registró un crecimiento de 12,1 % comparado con similar mes del 2024. Tomado de MIDAGRI, 2025
...
![Porciones acumuladas de frío](report/assets/graphics/porciones_acumuladas_frio.png){width=80%}

*Nota.* ENOS, acumulación de frío y alternancia productiva — Calvo et al., 2024
...
![Calidad del aceite](report/assets/graphics/calidad_aceite.png){width=80%}

*Nota.* Recuperado de Calvo et al., 2024
...
![medida_plaga_senasa](report/assets/graphics/medida_plaga_senasa.png){width=80%}

*Nota.* Recuperado de SENASA, 2024
...
![Severidad de ataque de las plagas](report/assets/graphics/ataque_plagas.png){width=80%}

*Nota.* Recuperado de Pino y Huayna, 2022

Tabla 2
Rango de afectación del cultivo del olivo, según índices de vegetación

![medida_plaga_senasa](report/assets/graphics/umbrales_ndvi.png){width=80%}

*Nota.* (a) La afectación es leve. (b) Ataque de plagas moderado. (c) Severidad del ataque de las plagas sumado al déficit hídrico. (d) Ataque de plagas muy fuerte y estado de marchitez permanente. Recuperado de Pino y Huayna, 2022
...
![Muestras de preparacion UAV](report/assets/graphics/uso_drones_uav.png){width=80%}

*Nota.* Recuperado de Pino et al., 2026

Figura 6
Inferencia del mejor modelo YOLOv8m en una imagen recortada.

![Muestra de DeepLearning](report/assets/graphics/uso_deep_learning.png){width=80%}

*Nota.* Osco‑Mamami et al., 2025
...
![Muestra del Lean UX de la solución Viora](report/assets/leanUX-canvas/Lean UX Canvas Viora.png){width=80%}

*Nota.* El Lean UX Canvas presenta la identificación del problema, segmentos de usuarios, propuestas de solución, hipótesis y el enfoque de producto mínimo viable (MVP) para la validación de la plataforma Viora. Elaboración propia.
