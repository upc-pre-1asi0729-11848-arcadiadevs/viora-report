...
Este informe presenta el trabajo final del curso **1ASI0729 - Desarrollo de Aplicaciones Open Source** de la Universidad Peruana de Ciencias Aplicadas. El proyecto consiste en el desarrollo de **Viora**, una plataforma SaaS B2B especializada en la gestión inteligente del ciclo de producción de aceitunas.
...
|--------|--------|------------------|
| Carpio Peña Josue Francisco | U202519273 |  |
...
- **Frontend**: Angular Framework con Angular Material (Material Design)
